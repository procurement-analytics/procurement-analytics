      ...
      <div>
        <header id="site-header" role="banner">
          <div className="inner">
            ...
            <h1 id="site-title"><a href="#/" title="Start"><img src="assets/graphics/layout/data-analytics-for-procurement-logo-neg.svg" alt="DAP logo" /><span></span><small>Mexico</small></a></h1>
            </div>
